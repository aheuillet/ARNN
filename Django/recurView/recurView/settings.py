"""
Django settings for recurView project.
...
# path to users data
PATH_TO_USERS_FOLDER = os.path.join(BASE_DIR, 'users/')
...
SECRET_KEY = ')j6i62qy*vd0=^i@@kop#3f&8p=anzfqm_&(g7$_4s(w$3^%*o'
...
WSGI_APPLICATION = 'recurView.wsgi.application'
